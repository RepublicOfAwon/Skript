 ...
 * @see SimpleLiteral
 */
public class UnparsedLiteral extends Expression<Object> implements Literal<Object> {
	...
	public <R> @Nullable Expression<? extends R> getConvertedExpression(ParseContext context, Class<? extends R>... to) {
		assert to.length > 0;
